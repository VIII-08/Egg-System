...
const submitAdd = () => {
    addForm.post(route('treasurer.expense-categories.store'), {
        preserveScroll: true,
        onSuccess: () => {
            Swal.fire({
                icon: 'success',
...
const submitDelete = (category) => {
    ...
    deleteForm.delete(route('treasurer.expense-categories.destroy', category.id), {
        preserveScroll: true,
        onSuccess: () => {
            Swal.fire({
                icon: 'success',
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                <div class="flex items-center gap-4">
                    ...
                    <select
                        :value="selectedRole"
                        @change="$inertia.get(route('treasurer.expense-categories.index'), { role: $event.target.value }, { preserveState: true })"

...
const submitAdd = () => {
    addForm.post(route('treasurer.egg-products.store'), {
        preserveScroll: true,
        onSuccess: () => {
            Swal.fire({
                icon: 'success',
...
const submitEdit = (productId) => {
    editForm.put(route('treasurer.egg-products.update', productId), {
        preserveScroll: true,
        onSuccess: () => {
            Swal.fire({
                icon: 'success',
...
const submitDelete = (product) => {
    ...
    deleteForm.delete(route('treasurer.egg-products.destroy', product.id), {
        preserveScroll: true,
        onSuccess: () => {
            Swal.fire({
                icon: 'success',

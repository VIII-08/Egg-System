...
<template>
    <Head title="Production Forecasting" />

    <StaffLayout>
        <template #header>Production Forecasting</template>

        <div class="space-y-6">
            <div class="bg-white p-6 rounded-lg shadow">
                <p class="text-gray-600">
                    Use this 14-day sales outlook to balance daily workloads, schedule manpower, and prepare enough inventory before peak demand hits.
                </p>
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                <h3 class="text-lg font-semibold text-gray-800 mb-4">Products Driving Demand</h3>
